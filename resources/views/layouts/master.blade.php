...
>
  <head>
    ...
    <link rel="stylesheet" href="{{asset('assets/vendor/fonts/boxicons.css')}}" /> <!--important -->
    ...
    <link rel="stylesheet" href="{{asset('assets/vendor/css/summernote.min.css')}}">
    <!-- Helpers -->
  ...
  <div class="layout-overlay layout-menu-toggle"></div>
    ...
    <!-- Summernote JS -->
    <script src="{{asset('assets/vendor/libs/summernote/summernote.min.js')}}" defer></script>
    <script src="{{asset('assets/vendor/libs/summernote/summernote.js')}}" defer></script>
    <!-- Active State JS -->
    <script src="{{asset('assets/js/active-state-nav.js')}}"></script>
</body>
</html>